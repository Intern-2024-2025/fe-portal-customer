<script setup>
import mainPhoto from "../../assets/images/service2a.png";
const items = [
  {
    id: 1,
    ...
    <div class="container">
      <div class="row pricing-title">
        <div class="col-12 text-center" data-aos="fade-up" data-aos-delay="0">
          <h2 class="heading">Application-Level Data Protection</h2>
          <p>
            Anthena-KMS Provides Highest Data Protection at Application Level
          </p>
        </div>
      </div>
      <div class="row justify-content-between align-items-center">
        <div class="col-lg-7 order-lg-2 js-custom-dots">
          <!-- <a
            href="#"
        ...
        <div class="col-lg-5">
          ...
          >
            ...
            <div class="service-contents">
              <h3>Basic Data Protection</h3>
              <p>
                • Server and Storage Storage Level <br />
